    ...
    const workExperiences = [
        {
            ...
            description: 'Full-stack development of the BRBytes homepage, teacher portal, and lesson editor. Improved UX with responsive Alpine.js components and API integrations using Postman. Redesigned backend database for scalability. Worked in a Scrum team using Agile methodologies.',
            icon: '💻',
        },
        {
            ...
            description: 'Contributed to cloud security operations by deploying Kubernetes clusters on AWS/GCP, integrating Jira Cloud and ServiceNow ITSM/SIR, and enhancing automated API testing with a custom differ. Investigated data mirroring and reference anomalies, reported backend bugs. Shadowed customer calls to deepen understanding of cloud security workflows and enterprise integrations.',
            icon: '🐳',
        },
    ];
        ...
        {workExperiences.map((exp, index) => (
          ...
          >
            ...
            >
              ...
              <h3 className="text-lg text-green-400">{exp.company}</h3>
